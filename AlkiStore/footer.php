			...
			<div class="col-md-4 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list1">
                    ...
                    <ul class="phone_email">
                        <li><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:0420826597">(+61) 420826597</a></li>
                        <li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:alki@grocery.com">store@grocery.com</a></li>
				    </ul>
				</ul>
			</div>
			<div class="clearfix"></div>
			<div class="wthree_footer_copy">
				<p>© <?=date('Y')?> Grocery Store. All rights reserved | Design by Alki Software</a></p>
			</div>
		</div>
</div>
<!-- //footer -->
